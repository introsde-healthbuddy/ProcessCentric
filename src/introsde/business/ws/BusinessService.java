 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://ws.business.introsde/", wsdlLocation = "http://10.218.204.126:6905/business?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://ws.business.introsde/", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.218.204.126:6905/business?wsdl");
    ...
    public Business getBusinessImplPort() {
        return super.getPort(new QName("http://ws.business.introsde/", "BusinessImplPort"), Business.class);
    }
    ...
    public Business getBusinessImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.business.introsde/", "BusinessImplPort"), Business.class, features);
    }
